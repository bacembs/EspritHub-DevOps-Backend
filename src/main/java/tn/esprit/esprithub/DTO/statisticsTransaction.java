...
public class statisticsTransaction {
    ...
    public statisticsTransaction(int janvier, int fevrier, int mars, int avril, int mai,
                                 int juin, int juillet, int aout, int septembre, int octobre,
                                 int novembre, int decembre) {
    ...
    public void setJuillet(int juillet) {
        this.juillet = juillet;
    }
